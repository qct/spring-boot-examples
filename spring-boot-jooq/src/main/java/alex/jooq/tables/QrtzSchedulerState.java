...
public class QrtzSchedulerState extends TableImpl<QrtzSchedulerStateRecord> {
     ...
     */
    public final TableField<QrtzSchedulerStateRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_scheduler_state.INSTANCE_NAME</code>.
     */
    public final TableField<QrtzSchedulerStateRecord, String> INSTANCE_NAME = createField("INSTANCE_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");
