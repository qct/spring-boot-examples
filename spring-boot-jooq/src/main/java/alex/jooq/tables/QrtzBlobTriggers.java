...
public class QrtzBlobTriggers extends TableImpl<QrtzBlobTriggersRecord> {
     ...
     */
    public final TableField<QrtzBlobTriggersRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_blob_triggers.TRIGGER_NAME</code>.
     */
    public final TableField<QrtzBlobTriggersRecord, String> TRIGGER_NAME = createField("TRIGGER_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_blob_triggers.TRIGGER_GROUP</code>.
     */
    public final TableField<QrtzBlobTriggersRecord, String> TRIGGER_GROUP = createField("TRIGGER_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");
