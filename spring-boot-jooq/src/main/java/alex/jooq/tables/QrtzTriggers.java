...
public class QrtzTriggers extends TableImpl<QrtzTriggersRecord> {
     ...
     */
    public final TableField<QrtzTriggersRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_triggers.TRIGGER_NAME</code>.
     */
    public final TableField<QrtzTriggersRecord, String> TRIGGER_NAME = createField("TRIGGER_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_triggers.TRIGGER_GROUP</code>.
     */
    public final TableField<QrtzTriggersRecord, String> TRIGGER_GROUP = createField("TRIGGER_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_triggers.JOB_NAME</code>.
     */
    public final TableField<QrtzTriggersRecord, String> JOB_NAME = createField("JOB_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_triggers.JOB_GROUP</code>.
     */
    public final TableField<QrtzTriggersRecord, String> JOB_GROUP = createField("JOB_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_triggers.DESCRIPTION</code>.
     */
    public final TableField<QrtzTriggersRecord, String> DESCRIPTION = createField("DESCRIPTION", org.jooq.impl.SQLDataType.VARCHAR(250), this, "");
     ...
     */
    public final TableField<QrtzTriggersRecord, String> TRIGGER_STATE = createField("TRIGGER_STATE", org.jooq.impl.SQLDataType.VARCHAR(16).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_triggers.TRIGGER_TYPE</code>.
     */
    public final TableField<QrtzTriggersRecord, String> TRIGGER_TYPE = createField("TRIGGER_TYPE", org.jooq.impl.SQLDataType.VARCHAR(8).nullable(false), this, "");
     ...
     */
    public final TableField<QrtzTriggersRecord, String> CALENDAR_NAME = createField("CALENDAR_NAME", org.jooq.impl.SQLDataType.VARCHAR(190), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_C, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_G, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_J, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_JG, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_NEXT_FIRE_TIME, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_NFT_MISFIRE, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_NFT_ST, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_NFT_ST_MISFIRE, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_NFT_ST_MISFIRE_GRP, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_N_G_STATE, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_N_STATE, Indexes.QRTZ_TRIGGERS_IDX_QRTZ_T_STATE, Indexes.QRTZ_TRIGGERS_PRIMARY);
    }
