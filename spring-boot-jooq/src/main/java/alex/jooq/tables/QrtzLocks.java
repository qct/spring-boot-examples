...
public class QrtzLocks extends TableImpl<QrtzLocksRecord> {
     ...
     */
    public final TableField<QrtzLocksRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_locks.LOCK_NAME</code>.
     */
    public final TableField<QrtzLocksRecord, String> LOCK_NAME = createField("LOCK_NAME", org.jooq.impl.SQLDataType.VARCHAR(40).nullable(false), this, "");
