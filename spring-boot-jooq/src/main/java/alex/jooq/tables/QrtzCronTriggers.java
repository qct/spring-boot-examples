...
public class QrtzCronTriggers extends TableImpl<QrtzCronTriggersRecord> {
     ...
     */
    public final TableField<QrtzCronTriggersRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_cron_triggers.TRIGGER_NAME</code>.
     */
    public final TableField<QrtzCronTriggersRecord, String> TRIGGER_NAME = createField("TRIGGER_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_cron_triggers.TRIGGER_GROUP</code>.
     */
    public final TableField<QrtzCronTriggersRecord, String> TRIGGER_GROUP = createField("TRIGGER_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_cron_triggers.CRON_EXPRESSION</code>.
     */
    public final TableField<QrtzCronTriggersRecord, String> CRON_EXPRESSION = createField("CRON_EXPRESSION", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_cron_triggers.TIME_ZONE_ID</code>.
     */
    public final TableField<QrtzCronTriggersRecord, String> TIME_ZONE_ID = createField("TIME_ZONE_ID", org.jooq.impl.SQLDataType.VARCHAR(80), this, "");
