...
public class QrtzCalendars extends TableImpl<QrtzCalendarsRecord> {
     ...
     */
    public final TableField<QrtzCalendarsRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_calendars.CALENDAR_NAME</code>.
     */
    public final TableField<QrtzCalendarsRecord, String> CALENDAR_NAME = createField("CALENDAR_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");
