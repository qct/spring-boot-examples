...
public class QrtzJobDetails extends TableImpl<QrtzJobDetailsRecord> {
     ...
     */
    public final TableField<QrtzJobDetailsRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.JOB_NAME</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> JOB_NAME = createField("JOB_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.JOB_GROUP</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> JOB_GROUP = createField("JOB_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.DESCRIPTION</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> DESCRIPTION = createField("DESCRIPTION", org.jooq.impl.SQLDataType.VARCHAR(250), this, "");

    /**
     * The column <code>test.qrtz_job_details.JOB_CLASS_NAME</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> JOB_CLASS_NAME = createField("JOB_CLASS_NAME", org.jooq.impl.SQLDataType.VARCHAR(250).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.IS_DURABLE</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> IS_DURABLE = createField("IS_DURABLE", org.jooq.impl.SQLDataType.VARCHAR(1).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.IS_NONCONCURRENT</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> IS_NONCONCURRENT = createField("IS_NONCONCURRENT", org.jooq.impl.SQLDataType.VARCHAR(1).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.IS_UPDATE_DATA</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> IS_UPDATE_DATA = createField("IS_UPDATE_DATA", org.jooq.impl.SQLDataType.VARCHAR(1).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_job_details.REQUESTS_RECOVERY</code>.
     */
    public final TableField<QrtzJobDetailsRecord, String> REQUESTS_RECOVERY = createField("REQUESTS_RECOVERY", org.jooq.impl.SQLDataType.VARCHAR(1).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.QRTZ_JOB_DETAILS_IDX_QRTZ_J_GRP, Indexes.QRTZ_JOB_DETAILS_IDX_QRTZ_J_REQ_RECOVERY, Indexes.QRTZ_JOB_DETAILS_PRIMARY);
    }
