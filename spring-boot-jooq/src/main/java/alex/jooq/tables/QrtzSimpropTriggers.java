...
public class QrtzSimpropTriggers extends TableImpl<QrtzSimpropTriggersRecord> {
     ...
     */
    public final TableField<QrtzSimpropTriggersRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.TRIGGER_NAME</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> TRIGGER_NAME = createField("TRIGGER_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.TRIGGER_GROUP</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> TRIGGER_GROUP = createField("TRIGGER_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.STR_PROP_1</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> STR_PROP_1 = createField("STR_PROP_1", org.jooq.impl.SQLDataType.VARCHAR(512), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.STR_PROP_2</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> STR_PROP_2 = createField("STR_PROP_2", org.jooq.impl.SQLDataType.VARCHAR(512), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.STR_PROP_3</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> STR_PROP_3 = createField("STR_PROP_3", org.jooq.impl.SQLDataType.VARCHAR(512), this, "");
     ...
     */
    public final TableField<QrtzSimpropTriggersRecord, BigDecimal> DEC_PROP_1 = createField("DEC_PROP_1", org.jooq.impl.SQLDataType.DECIMAL(13, 4), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.DEC_PROP_2</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, BigDecimal> DEC_PROP_2 = createField("DEC_PROP_2", org.jooq.impl.SQLDataType.DECIMAL(13, 4), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.BOOL_PROP_1</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> BOOL_PROP_1 = createField("BOOL_PROP_1", org.jooq.impl.SQLDataType.VARCHAR(1), this, "");

    /**
     * The column <code>test.qrtz_simprop_triggers.BOOL_PROP_2</code>.
     */
    public final TableField<QrtzSimpropTriggersRecord, String> BOOL_PROP_2 = createField("BOOL_PROP_2", org.jooq.impl.SQLDataType.VARCHAR(1), this, "");
