...
public class QrtzFiredTriggers extends TableImpl<QrtzFiredTriggersRecord> {
     ...
     */
    public final TableField<QrtzFiredTriggersRecord, String> SCHED_NAME = createField("SCHED_NAME", org.jooq.impl.SQLDataType.VARCHAR(120).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.ENTRY_ID</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> ENTRY_ID = createField("ENTRY_ID", org.jooq.impl.SQLDataType.VARCHAR(95).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.TRIGGER_NAME</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> TRIGGER_NAME = createField("TRIGGER_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.TRIGGER_GROUP</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> TRIGGER_GROUP = createField("TRIGGER_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.INSTANCE_NAME</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> INSTANCE_NAME = createField("INSTANCE_NAME", org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false), this, "");
     ...
     */
    public final TableField<QrtzFiredTriggersRecord, String> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(16).nullable(false), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.JOB_NAME</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> JOB_NAME = createField("JOB_NAME", org.jooq.impl.SQLDataType.VARCHAR(190), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.JOB_GROUP</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> JOB_GROUP = createField("JOB_GROUP", org.jooq.impl.SQLDataType.VARCHAR(190), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.IS_NONCONCURRENT</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> IS_NONCONCURRENT = createField("IS_NONCONCURRENT", org.jooq.impl.SQLDataType.VARCHAR(1), this, "");

    /**
     * The column <code>test.qrtz_fired_triggers.REQUESTS_RECOVERY</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> REQUESTS_RECOVERY = createField("REQUESTS_RECOVERY", org.jooq.impl.SQLDataType.VARCHAR(1), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.QRTZ_FIRED_TRIGGERS_IDX_QRTZ_FT_INST_JOB_REQ_RCVRY, Indexes.QRTZ_FIRED_TRIGGERS_IDX_QRTZ_FT_JG, Indexes.QRTZ_FIRED_TRIGGERS_IDX_QRTZ_FT_J_G, Indexes.QRTZ_FIRED_TRIGGERS_IDX_QRTZ_FT_TG, Indexes.QRTZ_FIRED_TRIGGERS_IDX_QRTZ_FT_TRIG_INST_NAME, Indexes.QRTZ_FIRED_TRIGGERS_IDX_QRTZ_FT_T_G, Indexes.QRTZ_FIRED_TRIGGERS_PRIMARY);
    }
